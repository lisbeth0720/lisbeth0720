...
> 
> [我的的博客](http://2015cewangxueqin.club)

# 前言
从 Jekyll 到 GitHub Pages 中间踩了许多坑，终于把我的个人博客[BY Blog](http://2015cewangxueqin.club)搭建出来了。。。

本教程针对的是不懂技术又想搭建个人博客的小白，操作简单暴力且快速。当然懂技术那就更好了。

看看看博客的主页样式：

[![](http://lisbeth0720.github.io/)
...
注册完成后搜索 `lisbeth0720.github.io` 进入[我的仓库](https://github.com/lisbeth0720/lisbeth0720.github.io)
...
这时你在在浏览器中输入 `你的Github账号名.github.io` 例如:`lisbeth0720.github.io`
...
> 很对人反映 Disqus 评论插件加载不出来，因为 Disqus 在国内加载缓慢，所以我新集成了 Gitalk 评论插件（感谢[@FeDemo](https://github.com/FeDemo)的推荐），喜欢折腾的朋友可以看这篇：[《为博客添加 Gitalk 评论插件》] 我已经在`_config.yml` 配置就好了，只需要填写参数可以了。
...
ga_domain: 2015cewangxueqin.club
```
...
friends: [
    {
        title: "简书·BY",
        href: "http://www.jianshu.com/u/6ae0befc341f"
    },{
        title: "Apple",
...
## 格式
每一篇文章文件命名采用的是`2019-02-04-Hello-2019.md`时间+标题的形式，空格用`-`替换连接。
...
一个主机记录为 `www`,代表可以解析 `www.2015cewangxueqin.club`的域名

另一个为 `@`, 代表 `2015cewangxueqin.club`
